...
public class AsyncQuestNew extends AsyncTask<Integer, Void, StructQuest> {
    ...
    protected StructQuest doInBackground(Integer... integers) {
        if (App.isOnline()) {
            return Commands.questNew(integers[0]);
        }
    ...
    public AsyncQuestNew setOperations(Operations operations) {
